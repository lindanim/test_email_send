...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'info@sineicthub.co.za');
define('EMAIL_TO_NAME', 'SINE ICT HUB');

define('EMAIL_TO_CC', 'fubu@gmail.com');
define('EMAIL_TO_CC_NAME', 'Sinethemba');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', 'sine@sineicthub.co.za');

define('EMAIL_FROM', 'info@sineicthub.co.za');
...
define('SMTP_HOST', 'mail.sineicthub.co.za');
define('SMTP_USER', 'info@sineicthub.co.za');
define('SMTP_PASS', '');
define('SMTP_AUTH', '');
